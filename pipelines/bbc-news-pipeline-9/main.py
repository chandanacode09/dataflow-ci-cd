...
class BbcNewsPipeline9Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-9"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-9 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline9Options)
