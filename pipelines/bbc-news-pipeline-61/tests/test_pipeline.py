"""
Unit tests for bbc-news-pipeline-61 streaming pipeline.
...
class TestBbcNewsPipeline61(unittest.TestCase):
    """Test cases for BbcNewsPipeline61 streaming pipeline"""
