...
class BbcNewsPipeline61Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-61"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-61 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline61Options)
