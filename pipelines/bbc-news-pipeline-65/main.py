...
class BbcNewsPipeline65Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-65"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-65 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline65Options)
