"""
Unit tests for bbc-news-pipeline-65 streaming pipeline.
...
class TestBbcNewsPipeline65(unittest.TestCase):
    """Test cases for BbcNewsPipeline65 streaming pipeline"""
