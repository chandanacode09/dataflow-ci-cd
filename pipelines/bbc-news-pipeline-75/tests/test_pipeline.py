"""
Unit tests for bbc-news-pipeline-75 streaming pipeline.
...
class TestBbcNewsPipeline75(unittest.TestCase):
    """Test cases for BbcNewsPipeline75 streaming pipeline"""
