...
class BbcNewsPipeline75Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-75"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-75 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline75Options)
