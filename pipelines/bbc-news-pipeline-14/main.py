...
class BbcNewsPipeline14Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-14"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-14 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline14Options)
