"""
Unit tests for bbc-news-pipeline-14 streaming pipeline.
...
class TestBbcNewsPipeline14(unittest.TestCase):
    """Test cases for BbcNewsPipeline14 streaming pipeline"""
