"""
Unit tests for bbc-news-pipeline-66 streaming pipeline.
...
class TestBbcNewsPipeline66(unittest.TestCase):
    """Test cases for BbcNewsPipeline66 streaming pipeline"""
