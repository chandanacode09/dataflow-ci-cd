...
class BbcNewsPipeline66Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-66"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-66 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline66Options)
