"""
Unit tests for bbc-news-pipeline-68 streaming pipeline.
...
class TestBbcNewsPipeline68(unittest.TestCase):
    """Test cases for BbcNewsPipeline68 streaming pipeline"""
