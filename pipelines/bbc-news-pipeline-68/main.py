...
class BbcNewsPipeline68Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-68"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-68 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline68Options)
