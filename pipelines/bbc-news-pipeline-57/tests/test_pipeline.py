"""
Unit tests for bbc-news-pipeline-57 streaming pipeline.
...
class TestBbcNewsPipeline57(unittest.TestCase):
    """Test cases for BbcNewsPipeline57 streaming pipeline"""
