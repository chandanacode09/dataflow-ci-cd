...
class BbcNewsPipeline57Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-57"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-57 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline57Options)
