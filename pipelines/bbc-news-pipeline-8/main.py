...
class BbcNewsPipeline8Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-8"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-8 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline8Options)
