"""
Unit tests for bbc-news-pipeline-60 streaming pipeline.
...
class TestBbcNewsPipeline60(unittest.TestCase):
    """Test cases for BbcNewsPipeline60 streaming pipeline"""
