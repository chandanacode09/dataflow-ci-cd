...
class BbcNewsPipeline60Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-60"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-60 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline60Options)
