...
class BbcNewsPipeline6Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-6"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-6 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline6Options)
