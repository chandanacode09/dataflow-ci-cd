...
class BbcNewsPipeline21Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-21"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-21 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline21Options)
