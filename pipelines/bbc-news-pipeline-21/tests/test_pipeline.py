"""
Unit tests for bbc-news-pipeline-21 streaming pipeline.
...
class TestBbcNewsPipeline21(unittest.TestCase):
    """Test cases for BbcNewsPipeline21 streaming pipeline"""
