...
class BbcNewsPipeline5Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-5"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-5 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline5Options)
