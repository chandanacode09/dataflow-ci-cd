"""
Unit tests for bbc-news-pipeline-45 streaming pipeline.
...
class TestBbcNewsPipeline45(unittest.TestCase):
    """Test cases for BbcNewsPipeline45 streaming pipeline"""
