...
class BbcNewsPipeline45Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-45"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-45 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline45Options)
