...
class BbcNewsPipeline67Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-67"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-67 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline67Options)
