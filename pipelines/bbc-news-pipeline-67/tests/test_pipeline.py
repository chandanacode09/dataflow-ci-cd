"""
Unit tests for bbc-news-pipeline-67 streaming pipeline.
...
class TestBbcNewsPipeline67(unittest.TestCase):
    """Test cases for BbcNewsPipeline67 streaming pipeline"""
