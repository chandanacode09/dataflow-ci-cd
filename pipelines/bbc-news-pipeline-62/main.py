...
class BbcNewsPipeline62Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-62"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-62 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline62Options)
