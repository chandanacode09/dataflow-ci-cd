"""
Unit tests for bbc-news-pipeline-62 streaming pipeline.
...
class TestBbcNewsPipeline62(unittest.TestCase):
    """Test cases for BbcNewsPipeline62 streaming pipeline"""
