"""
Unit tests for bbc-news-pipeline-52 streaming pipeline.
...
class TestBbcNewsPipeline52(unittest.TestCase):
    """Test cases for BbcNewsPipeline52 streaming pipeline"""
