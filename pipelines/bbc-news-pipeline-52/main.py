...
class BbcNewsPipeline52Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-52"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-52 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline52Options)
