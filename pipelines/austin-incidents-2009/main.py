...
class AustinIncidents2009Options(PipelineOptions):
    """Custom pipeline options for austin-incidents-2009"""
...
def run(argv=None):
    """
    Main entry point for the austin-incidents-2009 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(AustinIncidents2009Options)

    # Construct full table references
    input_table = f"{custom_options.project}:austin_incidents.incidents_2009"
    output_table = f"{custom_options.project}:austin_incidents.processed_incidents_2009"
