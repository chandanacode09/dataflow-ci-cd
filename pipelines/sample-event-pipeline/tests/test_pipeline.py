"""
Unit tests for sample-event-pipeline streaming pipeline.
...
class TestSampleEventPipeline(unittest.TestCase):
    """Test cases for SampleEventPipeline streaming pipeline"""
