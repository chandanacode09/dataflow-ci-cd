"""
Unit tests for bbc-news-pipeline-59 streaming pipeline.
...
class TestBbcNewsPipeline59(unittest.TestCase):
    """Test cases for BbcNewsPipeline59 streaming pipeline"""
