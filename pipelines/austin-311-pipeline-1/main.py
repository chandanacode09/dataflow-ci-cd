#!/usr/bin/env python3
"""
austin-311-pipeline-1 pipeline
...
class Austin311Pipeline1Options(PipelineOptions):
    """Custom pipeline options for austin-311-pipeline-1"""
...
def run(argv=None):
    """
    Main entry point for the austin-311-pipeline-1 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(Austin311Pipeline1Options)
