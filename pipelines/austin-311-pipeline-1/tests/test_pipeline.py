"""
Unit tests for austin-311-pipeline-1 streaming pipeline.
...
class TestAustin311Pipeline1(unittest.TestCase):
    """Test cases for Austin311Pipeline1 streaming pipeline"""
