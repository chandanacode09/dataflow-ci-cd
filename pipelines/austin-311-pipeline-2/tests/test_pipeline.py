"""
Unit tests for austin-311-pipeline-2 streaming pipeline.
...
class TestAustin311Pipeline2(unittest.TestCase):
    """Test cases for Austin311Pipeline2 streaming pipeline"""
