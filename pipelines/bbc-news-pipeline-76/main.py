...
class BbcNewsPipeline76Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-76"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-76 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline76Options)
