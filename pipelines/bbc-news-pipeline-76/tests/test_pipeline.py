"""
Unit tests for bbc-news-pipeline-76 streaming pipeline.
...
class TestBbcNewsPipeline76(unittest.TestCase):
    """Test cases for BbcNewsPipeline76 streaming pipeline"""
