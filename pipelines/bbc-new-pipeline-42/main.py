...
class BbcNewPipeline42Options(PipelineOptions):
    """Custom pipeline options for bbc-new-pipeline-42"""
...
def run(argv=None):
    """
    Main entry point for the bbc-new-pipeline-42 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewPipeline42Options)
