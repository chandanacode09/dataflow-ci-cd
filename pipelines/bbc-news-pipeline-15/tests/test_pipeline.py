"""
Unit tests for bbc-news-pipeline-15 streaming pipeline.
...
class TestBbcNewsPipeline15(unittest.TestCase):
    """Test cases for BbcNewsPipeline15 streaming pipeline"""
