...
class BbcNewsPipeline15Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-15"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-15 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline15Options)
