...
class BreathePipelineOptions(PipelineOptions):
    """Custom pipeline options for breathe-pipeline"""
...
def run(argv=None):
    """
    Main entry point for the breathe-pipeline streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BreathePipelineOptions)

    # Construct full table references
    input_table = f"{custom_options.project}:breathe.arxiv"
    output_table = f"{custom_options.project}:breathe.processed_breathe_arxiv"
