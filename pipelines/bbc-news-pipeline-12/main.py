...
class BbcNewsPipeline12Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-12"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-12 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline12Options)
