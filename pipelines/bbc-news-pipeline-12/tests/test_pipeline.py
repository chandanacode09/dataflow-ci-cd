"""
Unit tests for bbc-news-pipeline-12 streaming pipeline.
...
class TestBbcNewsPipeline12(unittest.TestCase):
    """Test cases for BbcNewsPipeline12 streaming pipeline"""
