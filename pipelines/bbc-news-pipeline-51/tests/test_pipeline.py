"""
Unit tests for bbc-news-pipeline-51 streaming pipeline.
...
class TestBbcNewsPipeline51(unittest.TestCase):
    """Test cases for BbcNewsPipeline51 streaming pipeline"""
