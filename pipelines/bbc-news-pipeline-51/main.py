...
class BbcNewsPipeline51Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-51"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-51 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline51Options)
