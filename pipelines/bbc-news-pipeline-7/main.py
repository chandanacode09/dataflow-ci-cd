...
class BbcNewsPipeline7Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-7"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-7 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline7Options)
