...
class BbcNewsPipeline30Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-30"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-30 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline30Options)
