"""
Unit tests for bbc-news-pipeline-30 streaming pipeline.
...
class TestBbcNewsPipeline30(unittest.TestCase):
    """Test cases for BbcNewsPipeline30 streaming pipeline"""
