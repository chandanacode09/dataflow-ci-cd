...
class BbcNewsPipeline79Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-79"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-79 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline79Options)
