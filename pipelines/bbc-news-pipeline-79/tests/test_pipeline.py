"""
Unit tests for bbc-news-pipeline-79 streaming pipeline.
...
class TestBbcNewsPipeline79(unittest.TestCase):
    """Test cases for BbcNewsPipeline79 streaming pipeline"""
