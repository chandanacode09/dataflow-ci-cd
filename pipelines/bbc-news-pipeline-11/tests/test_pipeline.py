"""
Unit tests for bbc-news-pipeline-11 streaming pipeline.
...
class TestBbcNewsPipeline11(unittest.TestCase):
    """Test cases for BbcNewsPipeline11 streaming pipeline"""
