...
class BbcNewsPipeline11Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-11"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-11 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline11Options)
