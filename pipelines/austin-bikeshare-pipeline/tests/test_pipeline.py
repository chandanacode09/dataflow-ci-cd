"""
Unit tests for austin-bikeshare-pipeline streaming pipeline.
...
class TestAustinBikesharePipeline(unittest.TestCase):
    """Test cases for AustinBikesharePipeline streaming pipeline"""
