"""
Unit tests for bbc-news-pipeline-35 streaming pipeline.
...
class TestBbcNewsPipeline35(unittest.TestCase):
    """Test cases for BbcNewsPipeline35 streaming pipeline"""
