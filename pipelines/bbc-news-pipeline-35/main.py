...
class BbcNewsPipeline35Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-35"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-35 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline35Options)
