"""
Unit tests for bbc-news-pipeline-70 streaming pipeline.
...
class TestBbcNewsPipeline70(unittest.TestCase):
    """Test cases for BbcNewsPipeline70 streaming pipeline"""
