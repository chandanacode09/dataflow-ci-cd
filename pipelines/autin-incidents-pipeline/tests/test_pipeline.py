"""
Unit tests for autin-incidents-pipeline streaming pipeline.
...
class TestAutinIncidentsPipeline(unittest.TestCase):
    """Test cases for AutinIncidentsPipeline streaming pipeline"""
