...
class BbcNewsPipeline58Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-58"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-58 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline58Options)
