"""
Unit tests for bbc-news-pipeline-58 streaming pipeline.
...
class TestBbcNewsPipeline58(unittest.TestCase):
    """Test cases for BbcNewsPipeline58 streaming pipeline"""
