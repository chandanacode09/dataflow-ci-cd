"""
Unit tests for bbc-news-pipeline-40 streaming pipeline.
...
class TestBbcNewsPipeline40(unittest.TestCase):
    """Test cases for BbcNewsPipeline40 streaming pipeline"""
