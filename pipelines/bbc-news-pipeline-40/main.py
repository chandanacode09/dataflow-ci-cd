...
class BbcNewsPipeline40Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-40"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-40 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline40Options)
