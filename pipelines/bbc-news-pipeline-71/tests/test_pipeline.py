"""
Unit tests for bbc-news-pipeline-71 streaming pipeline.
...
class TestBbcNewsPipeline71(unittest.TestCase):
    """Test cases for BbcNewsPipeline71 streaming pipeline"""
