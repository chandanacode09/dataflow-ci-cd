...
class BbcNewsPipeline71Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-71"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-71 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline71Options)
