"""
Unit tests for bbc-news-pipeline-20 streaming pipeline.
...
class TestBbcNewsPipeline20(unittest.TestCase):
    """Test cases for BbcNewsPipeline20 streaming pipeline"""
