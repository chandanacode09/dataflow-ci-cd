# Terraform Configuration for bbc-news-pipeline-20 Triggers

This directory contains Terraform configuration to create Cloud Build triggers for the bbc-news-pipeline-20 pipeline.
...
```bash
cd pipelines/bbc-news-pipeline-20/terraform
terraform init
```
...
This will create:
- **CI Trigger**: `bbc-news-pipeline-20-ci` - Runs on all branches
- **CD Trigger**: `bbc-news-pipeline-20-cd` - Deploys on main branch
...
- Prefix: `dataflow-pipelines/bbc-news-pipeline-20`
