...
class BbcNewsPipeline20Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-20"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-20 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline20Options)
