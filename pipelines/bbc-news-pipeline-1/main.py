...
class BbcNewsPipeline1Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-1"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-1 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline1Options)
