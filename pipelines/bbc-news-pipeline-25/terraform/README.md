# Terraform Configuration for bbc-news-pipeline-25 Triggers

This directory contains Terraform configuration to create Cloud Build triggers for the bbc-news-pipeline-25 pipeline.
...
```bash
cd pipelines/bbc-news-pipeline-25/terraform
terraform init
```
...
This will create:
- **CI Trigger**: `bbc-news-pipeline-25-ci` - Runs on all branches
- **CD Trigger**: `bbc-news-pipeline-25-cd` - Deploys on main branch
...
- Prefix: `dataflow-pipelines/bbc-news-pipeline-25`
