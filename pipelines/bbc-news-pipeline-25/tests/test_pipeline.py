"""
Unit tests for bbc-news-pipeline-25 streaming pipeline.
...
class TestBbcNewsPipeline25(unittest.TestCase):
    """Test cases for BbcNewsPipeline25 streaming pipeline"""
