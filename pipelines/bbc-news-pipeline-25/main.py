...
class BbcNewsPipeline25Options(PipelineOptions):
    """Custom pipeline options for bbc-news-pipeline-25"""
...
def run(argv=None):
    """
    Main entry point for the bbc-news-pipeline-25 streaming pipeline.
    """
    ...
    custom_options = pipeline_options.view_as(BbcNewsPipeline25Options)
